...
export const taxaApi = {
  ...
  getInaturalist: (aphiaId) => apiClient.get(`/taxa/${aphiaId}/inaturalist`),
  getStatuses: () => apiClient.get('/taxa/statuses'),
  wormsLookup: (q) => apiClient.get('/taxa/worms-lookup', { params: { q } }),
