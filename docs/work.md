...
```bash
# 干净机器部署全流程
sudo apt-get install -y python3-pip              # basedpyright 依赖
curl -fsSL https://deb.nodesource.com/setup_22.x | sudo -E bash -
sudo apt-get install -y nodejs                   # Node.js 22 LTS
pip install --user --break-system-packages basedpyright
sudo npm install -g typescript-language-server typescript @vue/language-server @playwright/mcp
